...
const TYPES_DEPENSE = [
  { value: "SEMENCES", label: "Semences", icon: <Sprout size={16} /> },
  { value: "ENGRAIS", label: "Engrais", icon: <Package size={16} /> },
  { value: "NOURRITURE_ANIMAUX", label: "Nourriture animaux", icon: <Rabbit size={16} /> },
  { value: "SALAIRES", label: "Salaires", icon: <Users size={16} /> },
  { value: "MEDICAMENTS", label: "Médicaments", icon: <Syringe size={16} /> },
  { value: "EQUIPEMENT", label: "Équipement & matériel", icon: <Wrench size={16} /> },
  { value: "CARBURANT", label: "Carburant", icon: <Fuel size={16} /> },
  ...
  return (
    <div className="w-full">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="font-semibold text-gray-900">Nouvelle Dépense</h2>
      </div>
